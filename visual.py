...
def load_transe(ent_list, model_time = '09161640'):
    ...
    ent_embeds = get_embeds(transe.ent_embeddings, ent_list) # (81600, 200)
    return ent_embeds
...
def visual(mod = 'transe', model_time = '09161640'):
    ...
    if mod == 'transe':
        ent_embeds = load_transe(ent_list, model_time)
        title = 'transe'
    elif mod == 'bert':
...
if __name__ == '__main__':
    ...
    # visual('transe')
    # ent_dict, ent_list, ent_name, ent_type, type_dict = get_entity()
    # get_bert_emb(ent_list, ent_name)
